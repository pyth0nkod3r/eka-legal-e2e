        ...
        {clientFilter && clientName && (
          <div className="flex items-center gap-2">
            <Badge variant="secondary" className="py-1.5 px-3 text-sm">
              ...
              Showing cases for:{" "}
              <span className="font-semibold ml-1">{clientName}</span>
            </Badge>
                    ...
                    <TableRow key={caseItem.id}>
                      ...
                      <TableCell>
                        ...
                        >
                          ...
                          {caseItem.documents.length === 1 ? "doc" : "docs"}
                        </Button>
                      </TableCell>
                      <TableCell>
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            <DropdownMenuItem
                              onClick={() =>
                                toast({
                                  title: "Coming Soon",
                                  description:
                                    "Case details view will be available soon.",
                                })
                              }
                            >
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                handleStatusChange(caseItem, "active")
                              }
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                handleStatusChange(caseItem, "pending")
                              }
                            ...
                            <DropdownMenuItem
                              onClick={() =>
                                handleStatusChange(caseItem, "closed")
                              }
