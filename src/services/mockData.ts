...
export const mockLawyerProfile: LawyerProfile = {
  ...
  bio: 'With over 15 years of distinguished experience in corporate law, estate planning, and civil litigation, Eka Utibe has built a reputation for delivering exceptional legal counsel with a personal touch. She founded Eka Legal Consultancy with a vision to provide accessible, high-quality legal services to individuals and businesses alike.',
...
export const mockServices: Service[] = [
  ...
  },
  {
    ...
    description: 'Protection for your creative works, inventions, and brand identity.',
    icon: 'Lightbulb',
    features: [
  ...
  },
  {
    ...
    description: 'Compassionate representation for those injured due to negligence.',
    icon: 'HeartPulse',
    features: [
      'Auto accidents',
      'Medical malpractice',
  ...
  },
  {
    id: 'service-9',
    title: 'Immigration',
    description: 'Navigating complex immigration laws for individuals and businesses.',
    icon: 'Globe',
    features: [
      'Visa applications',
      'Green cards',
...
export const mockTestimonials: Testimonial[] = [
  {
    ...
    content: 'Eka guided us through a complex merger with exceptional skill and attention to detail. Her strategic approach saved us both time and money. I couldn\'t recommend her services more highly.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'The estate planning process was explained clearly and handled with great sensitivity. Eka made what could have been an overwhelming experience feel manageable and secure.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'Outstanding legal representation in my property dispute. Eka\'s expertise in civil litigation was evident from day one, and her dedication to my case was unwavering.',
    rating: 5,
  ...
  },
  {
    ...
    content: 'From incorporation to investor agreements, Eka has been our go-to legal advisor. Her business acumen combined with legal expertise is truly rare.',
    rating: 5,
