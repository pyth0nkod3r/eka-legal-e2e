...
describe('Navbar Component', () => {
  it('renders the logo and brand name', () => {
    ...
    expect(screen.getByText('Mitchell Legal')).toBeInTheDocument();
  });
...
describe('Footer Component', () => {
  ...
  it('renders contact information', () => {
    ...
    expect(screen.getByText('Contact')).toBeInTheDocument();
    expect(screen.getByText('123 Legal Ave, New York, NY')).toBeInTheDocument();
    expect(screen.getByText('+1 (555) 987-6543')).toBeInTheDocument();
    expect(screen.getByText('info@mitchelllegal.com')).toBeInTheDocument();
  });
  ...
  it('renders copyright text', () => {
    ...
    expect(screen.getByText(/© 2024 Mitchell Legal Consultancy/)).toBeInTheDocument();
  });
