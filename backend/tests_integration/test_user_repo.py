...
class TestUserRepository:
    ...
    async def test_get_user_by_email(self, seeded_db):
        ...
        user = await user_repo.get_user_by_email(seeded_db, "john.doe@email.com")
    ...
    async def test_get_user_by_id(self, seeded_db):
        ...
        user = await user_repo.get_user_by_id(seeded_db, "user-1")
    ...
    async def test_update_user(self, seeded_db):
        ...
        updated = await user_repo.update_user(
            seeded_db, "user-1", name="Updated Name", phone="+9999999999"
        )
